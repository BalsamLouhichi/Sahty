 ...
 */
final class Version20260209222413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recommandation (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, min_score INT NOT NULL, max_score INT NOT NULL, type_probleme VARCHAR(500) NOT NULL, created_at DATETIME NOT NULL, quiz_id INT NOT NULL, INDEX IDX_C7782A28853CD175 (quiz_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
